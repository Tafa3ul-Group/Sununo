...
const styles = StyleSheet.create({
  ...
  notesLabel: { fontSize: normalize.font(13), fontWeight: '700', fontFamily: "LamaSans-Bold", color: Colors.text.primary },
  notesText: { fontSize: normalize.font(13), color: Colors.text.muted, lineHeight: 18 , fontFamily: "LamaSans-Regular" },
  inputLabel: { fontSize: normalize.font(14), fontWeight: '700', fontFamily: "LamaSans-Bold", marginBottom: 8, color: Colors.text.primary },
