...
const styles = StyleSheet.create({
  ...
  notesLabel: { fontSize: normalize.font(13), fontWeight: '700', color: Colors.text.primary },
  notesText: { fontSize: normalize.font(13), color: Colors.text.muted, lineHeight: 18 },
  inputLabel: { fontSize: normalize.font(14), fontWeight: '700', marginBottom: 8, color: Colors.text.primary },
