 ...
 * Solar Icons List
 * 
 * Paste your components here from Iconify (React Native tab).
...
export function Solar4kBold(props: any) {
  return (
    <Svg width={props.size} height={props.size} viewBox="0 0 24 24" color={props.color}>
      <Path 
        fill="currentColor" 
        fillRule="evenodd" 
...
export const SOLAR_REGISTRY: Record<string, React.FC<any>> = {
  '4k-bold': Solar4kBold,
};
