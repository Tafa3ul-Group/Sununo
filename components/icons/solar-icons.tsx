...
export function SolarCheckCircleBoldDuotone({
  size = 24,
  color,
  ...props
}: SolarIconProps) {
...
export function SolarClipboardListLineDuotone({
  size = 24,
  color,
  ...props
}: SolarIconProps) {
...
export function SolarGalleryWideLinear({
  size = 24,
  color,
  ...props
}: SolarIconProps) {
...
export function SolarPenNewRoundBoldDuotone({
  size = 24,
  color,
  ...props
}: SolarIconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" {...props}>
      <Circle cx="12" cy="12" r="10" fill={c} opacity={0.5} />
      <Path
        fill={c}
