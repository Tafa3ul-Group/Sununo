...
const styles = StyleSheet.create({
  ...
  popoverTitle: { fontSize: 14, fontFamily: "IBMPlexSansArabic-SemiBold", color: Colors.text.primary, flex: 1 },
  ...
  chaletItemName: { fontSize: 14, fontFamily: "IBMPlexSansArabic-SemiBold", color: '#333' },
  addNewChaletBtn: {
    padding: 12, marginHorizontal: 12, marginTop: 4, borderRadius: 12,
    backgroundColor: '#F8F9FB', alignItems: 'center' },
  addNewChaletText: { fontSize: 13, fontFamily: "IBMPlexSansArabic-Medium", color: Colors.primary },
  chaletAvatarImg: {
    width: '100%',
    height: '100%',
    borderRadius: 99 },
