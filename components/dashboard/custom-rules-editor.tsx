...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 15, fontFamily: 'IBMPlexSansArabic-Bold', color: '#0F172A' },
  headerSubtitle: { fontSize: 12, fontFamily: 'IBMPlexSansArabic-Regular', color: '#94A3B8', marginTop: 3 },
  countBadge: {
  ...
  countBadgeText: { fontSize: 11, fontFamily: 'IBMPlexSansArabic-Bold', color: Colors.primary },
  addBtn: {
    alignItems: 'center',
    gap: 4,
    borderRadius: 12,
  ...
  addBtnPlus: { fontSize: 16, color: Colors.primary, fontFamily: 'IBMPlexSansArabic-Bold', marginTop: -2 },
  addBtnText: { fontSize: 12, color: Colors.primary, fontFamily: 'IBMPlexSansArabic-Bold' },
  emptyBox: {
    borderRadius: 12,
  ...
  checkmark: { color: '#FFF', fontSize: 12, fontFamily: 'IBMPlexSansArabic-Bold', marginTop: -1 },
  ruleTitle: { fontSize: 13, fontFamily: 'IBMPlexSansArabic-Bold', color: '#1E293B' },
  ruleContent: {
    fontSize: 11.5,
  ...
  cancelBtnText: { fontSize: 14, fontFamily: 'IBMPlexSansArabic-Bold', color: '#64748B' },
  saveBtn: {
    flex: 2,
    height: 48,
    borderRadius: 24,
  ...
  saveBtnText: { fontSize: 14, fontFamily: 'IBMPlexSansArabic-Bold', color: '#FFF' },
  ...
  fieldLabel: { fontSize: 11, fontFamily: 'IBMPlexSansArabic-Medium', color: '#94A3B8' },
  ruleInput: {
    backgroundColor: '#F8FAFC',
    borderRadius: 10,
    paddingHorizontal: 12,
