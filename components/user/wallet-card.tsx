...
export const WalletCard = ({ balance = "100,000", onWithdraw }: WalletCardProps) => {
  return (
...
const styles = StyleSheet.create({
  ...
  withdrawButton: {
    ...
    alignItems: 'center',
    paddingRight: 12, // Moved text slightly to the left
  },
  withdrawText: {
    color: 'white',
    fontSize: 20,
