  ...
  const menuItems = [
    {
      ...
      icon: <SolarUserBold size={22} />,
      route: "/(tabs)/(customer)/profile",
    },
    {
      id: "bookings",
      label: t("headers.bookings"),
      icon: <SolarCalendarBold size={22} />,
      route: "/(tabs)/(customer)/bookings",
    },
    {
      id: "favorites",
      label: t("headers.favorites"),
      icon: <SolarHeartBold size={22} />,
      route: "/favorites",
    },
    {
      id: "notifications",
      label: t("headers.notifications"),
      icon: <SolarBellBingBoldDuotone size={22} />,
      route: "/(customer)/notifications",
    },
    {
      id: "settings",
      label: t("profile.language"),
      icon: <SolarSettingsBold size={22} />,
      route: "/(tabs)/(customer)/profile",
    },
  ];
