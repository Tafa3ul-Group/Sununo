...
export function HorizontalCard({
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.9}
      onPress={onPress}
      style={[styles.container, { flexDirection: "row-reverse" }, style]}
    >
      {/* info side */}
      <View style={styles.contentAndLeft}>
        ...
        <View style={[styles.topRow, { flexDirection: "row-reverse" }]}>
          ...
          <View style={styles.mainContent}>
            <View style={[styles.upperText, { alignItems: "flex-start" }]}>
              <ThemedText
        ...
        <View style={[styles.bottomRow, { flexDirection: "row-reverse" }]}>
...
const styles = StyleSheet.create({
  ...
  bottomRow: {
    ...
    justifyContent: "space-between",
    alignItems: "center",
    paddingStart: normalize.width(6), // لضبط موضع النجمة تحت القلب
  },
  ratingBox: {
    flexDirection: "row",
    alignItems: "center",
