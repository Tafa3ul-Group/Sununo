...
const styles = StyleSheet.create({
  ...
  h1: { color: '#fff', fontSize: 22, fontFamily: 'Alexandria-Bold' },
  ...
  btnText: { color: '#fff', fontFamily: 'Alexandria-Bold' },
  panel: { backgroundColor: '#1E293B', borderRadius: 14, padding: 12, gap: 8 },
  panelTitle: { color: '#fff', fontFamily: 'Alexandria-Bold', fontSize: 14 },
  ...
  boxText: { color: '#fff', fontFamily: 'Alexandria-Bold' },
