...
export default function ChaletDetailScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
                  ...
                  {images.map((_: any, i: number) => (
                    <View
                      ...
                      style={[
                        styles.dot,
                        {
                          backgroundColor: i === activeIndex ? '#035DF9' : 'rgba(255,255,255,0.7)',
        ...
        <View style={styles.contentWrapper}>
          <View style={styles.premiumCard}>
            ...
            <Text style={[styles.sectionTitle, { textAlign: isRTL ? 'right' : 'left' }]}>المواصفات الاساسية</Text>
            <View style={[styles.specsRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
               <View style={styles.specTag}><Text style={styles.specText}>بستان مع بيت</Text></View>
               <View style={styles.specTag}><Text style={styles.specText}>300 م</Text></View>
               <View style={styles.specTag}><Text style={styles.specText}>1 حمام</Text></View>
               <View style={styles.specTag}><Text style={styles.specText}>3 غرف</Text></View>
            </View>
            ...
            <View style={[styles.amenitiesGrid, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
               {[
                 ...
                 <View key={idx} style={styles.amenityItem}>
                   <View style={[styles.amenityIconContainer, { backgroundColor: item.color }]}>
            ...
            {/* 3. Overview Section */}
            <Text style={[styles.sectionTitle, { textAlign: isRTL ? 'right' : 'left', marginTop: 24 }]}>نظرة عامة</Text>
            <Text style={[styles.overviewText, { textAlign: isRTL ? 'right' : 'left' }]}>
              هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر. كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما قامت مطبعة مجهولة برص مجموعة من الأحرف بشكل عشوائي أخذتها من نص، لتكوّن كتيب بمثابة دليل أو مرجع شكلي....
            </Text>
            ...
            <View style={styles.reviewsList}>
               {[
                 ...
                 <View key={idx} style={[styles.reviewItem, { flexDirection: isRTL ? 'row' : 'row-reverse' }]}>
                    <Image source={review.avatar} style={styles.reviewerAvatar} />
                    <View style={[styles.reviewTextContent, { alignItems: isRTL ? 'flex-end' : 'flex-start' }]}>
                       <Text style={styles.reviewerName}>{review.name}</Text>
                       <View style={[styles.reviewRatingRow, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
            ...
            <Text style={[styles.sectionTitle, { textAlign: isRTL ? 'right' : 'left', marginTop: 40 }]}>معلومات تهمك</Text>
            <View style={[styles.infoInterestGrid, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
               {[
      ...
      {/* Fixed Footer */}
      <View style={[styles.fixedFooter, { flexDirection: isRTL ? 'row' : 'row-reverse' }]}>
        <View style={styles.footerPriceContainer}>
          <Text style={styles.footerPrice}>30,000 IQD</Text>
          <Text style={styles.footerPriceDetails}>شفت صباحي . 23 اكتوبر . 5 بالغين</Text>
        </View>
        <PrimaryButton 
          label="احجز الان"
          onPress={() => {}}
...
const styles = StyleSheet.create({
  ...
  hostJaggedCard: {
    ...
    borderRadius: 28,
    padding: 2, // Tiny padding for the "border" effect
    alignItems: 'center',
    justifyContent: 'center',
  },
  hostStickerImage: {
