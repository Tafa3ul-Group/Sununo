...
const styles = StyleSheet.create({
  ...
  dateBadgeText: { fontSize: normalize.font(16), fontWeight: '700', fontFamily: "LamaSans-Bold", color: '#94A3B8' },
  dateBadgeTextActive: { color: Colors.primary, fontWeight: '800', fontFamily: "LamaSans-Black" },
  ...
  calendarMonthTitle: { textAlign: 'center', fontSize: normalize.font(16), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#1E293B', marginBottom: 15 },
  ...
  dayHeaderCell: { fontSize: normalize.font(10), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#94A3B8', width: (SCREEN_WIDTH - 100) / 7, textAlign: 'center' },
  ...
  dayText: { fontSize: normalize.font(14), fontWeight: '700', fontFamily: "LamaSans-Bold", color: '#334155' },
  activeDayText: { color: '#FFF', fontWeight: '900', fontFamily: "LamaSans-Black" },
  bookedDayText: { color: '#CBD5E1', fontWeight: '400', fontFamily: "LamaSans-Regular" },
  ...
  shiftTitle: { fontSize: normalize.font(15), fontWeight: '800', fontFamily: "LamaSans-Black", color: '#1E293B' },
  shiftTime: { fontSize: normalize.font(12), color: '#64748B', fontWeight: '700', fontFamily: "LamaSans-Bold" },
  deleteDayBtn: { alignItems: 'center', marginTop: 30, padding: 8 },
  deleteDayText: { color: '#EF4444', fontSize: normalize.font(14), fontWeight: '800', fontFamily: "LamaSans-Black", textDecorationLine: 'underline' },
  ...
  guestLabel: { fontSize: normalize.font(16), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#111827' },
  guestSubLabel: { fontSize: normalize.font(12), color: '#9CA3AF', fontWeight: '600', fontFamily: "LamaSans-SemiBold", marginTop: 1 },
  ...
  inlinePaymentTitle: { fontSize: normalize.font(18), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#1E293B', marginBottom: 15, textAlign: isRTL ? 'right' : 'left' },
  paymentForm: { gap: 12 },
  inputGroup: { gap: 6 },
  inputGroupFull: { flex: 1, gap: 6 },
  inputGroupFixed: { width: 90, gap: 6 },
  inputLabel: { fontSize: normalize.font(14), fontWeight: '800', fontFamily: "LamaSans-Black", color: '#1E293B', textAlign: isRTL ? 'right' : 'left' },
  textInput: {
    backgroundColor: '#FFFFFF',
    borderWidth: 1.5,
    borderColor: '#F1F5F9',
  ...
  successTitle: { fontSize: normalize.font(20), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#1E293B', marginBottom: 8, textAlign: 'center' },
  ...
  mapAddressLabel: { textAlign: 'center', paddingVertical: 8, fontSize: normalize.font(12), fontWeight: '800', fontFamily: "LamaSans-Black", color: '#1E293B' },
  infoSectionCard: { 
    backgroundColor: '#FFFFFF', 
    borderRadius: 20, 
    padding: 16, 
  ...
  sectionTitle: { fontSize: normalize.font(14), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#15AB64', textAlign: isRTL ? 'right' : 'left' },
  divider: { height: 1, backgroundColor: '#F1F5F9', marginVertical: 10 },
  infoRow: { flexDirection: isRTL ? 'row-reverse' : 'row', justifyContent: 'space-between', marginBottom: 10 },
  infoLabel: { fontSize: normalize.font(13), fontWeight: '800', fontFamily: "LamaSans-Black", color: '#1E293B' },
  infoValue: { fontSize: normalize.font(13), fontWeight: '700', fontFamily: "LamaSans-Bold", color: '#64748B' },
  ...
  editBtnText: { color: '#15AB64', fontSize: normalize.font(12), fontWeight: '800', fontFamily: "LamaSans-Black" },
  paymentMainTitle: { fontSize: normalize.font(14), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#15AB64', marginVertical: 12, textAlign: isRTL ? 'right' : 'left' },
  paymentOptionCard: { 
  ...
  paymentVal: { fontSize: normalize.font(15), fontWeight: '900', fontFamily: "LamaSans-Black", color: '#64748B' },
  paymentValActive: { color: '#1E293B' , fontFamily: "LamaSans-Regular" },
  paymentLabel: { fontSize: normalize.font(13), fontWeight: '800', fontFamily: "LamaSans-Black", color: '#64748B' },
  ...
  agreementLink: { color: Colors.primary, textDecorationLine: 'underline', fontWeight: '800', fontFamily: "LamaSans-Black" }
});
