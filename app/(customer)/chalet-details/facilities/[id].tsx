      ...
      <HeaderSection title={t('headers.facilities')} showBackButton showLogo={false} userType={userType} />
       ...
       >
          <View style={{ paddingHorizontal: 20 }}>
              {/* الخدمات العامة */}
              <SectionHeader title={t('facilities.general')} isRTL={isRTL} />
              <FacilityCard label={t('facilities.wifi')} color="#FF4500" Icon={SolarWifiBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.garage')} color="#FF4500" Icon={SolarHome2Bold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.generator')} color="#FF4500" Icon={SolarWindBold} isRTL={isRTL} />

              {/* الحمام */}
              <SectionHeader title={t('facilities.bathroom')} isRTL={isRTL} />
              <FacilityCard label={t('facilities.essentials')} subtext={t('facilities.essentialsDesc')} color="#035DF9" Icon={SolarLockBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.hairDryer')} color="#035DF9" Icon={SolarWindBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.shampoo')} color="#035DF9" Icon={SolarWaterBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.soap')} color="#035DF9" Icon={SolarWaterBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.hotWater')} color="#035DF9" Icon={SolarWaterBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.outdoorSinks')} color="#035DF9" Icon={SolarWaterBold} isRTL={isRTL} />

              {/* المطبخ */}
              <SectionHeader title={t('facilities.kitchen')} isRTL={isRTL} />
              <FacilityCard label={t('facilities.fullKitchen')} subtext={t('facilities.kitchenDesc')} color="#15AB64" Icon={SolarHome2Bold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.cookingTools')} subtext={t('facilities.toolsDesc')} color="#15AB64" Icon={SolarSettingsBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.table')} subtext={t('facilities.tableDesc')} color="#15AB64" Icon={SolarWidgetBold} isRTL={isRTL} />

              {/* الميزات الخارجية */}
              <SectionHeader title={t('facilities.outdoorFeatures')} isRTL={isRTL} />
              <FacilityCard label={t('facilities.privatePool')} color="#FF69B4" Icon={SolarWaterBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.bbqArea')} color="#FF69B4" Icon={SolarFireBold} isRTL={isRTL} />
              <FacilityCard label={t('facilities.outdoorSeating')} color="#FF69B4" Icon={SolarHome2Bold} isRTL={isRTL} />
          </View>
       </ScrollView>
    </SafeAreaView>
  );
