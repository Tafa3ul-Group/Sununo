...
const styles = StyleSheet.create({
  ...
  input: { height: normalize.height(48), backgroundColor: '#FFFFFF', borderRadius: normalize.radius(12), paddingHorizontal: Spacing.md, borderWidth: 1, borderColor: '#E8E8E8', fontSize: normalize.font(15), color: Colors.text.primary, fontFamily: "Alexandria-Regular" },
  ...
  dayLabel: { fontSize: normalize.font(10), fontFamily: "Alexandria-Bold", color: Colors.text.muted },
  ...
  categorySectionTitle: { fontSize: normalize.font(16), fontFamily: "Alexandria-Black", color: Colors.text.primary, textAlign: 'center', marginBottom: 8 },
  featuresList: { gap: 8 },
  ...
  featureName: { fontSize: normalize.font(14), fontFamily: "Alexandria-Bold", color: Colors.text.primary, flex: 1 },
  ...
  uploadText: { marginTop: 4, color: Colors.text.muted, fontSize: normalize.font(12), fontFamily: "Alexandria-SemiBold" },
