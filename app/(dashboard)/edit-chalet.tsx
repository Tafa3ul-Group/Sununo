...
const styles = StyleSheet.create({
  ...
  input: { height: normalize.height(48), backgroundColor: '#FFFFFF', borderRadius: normalize.radius(12), paddingHorizontal: Spacing.md, borderWidth: 1, borderColor: '#E8E8E8', fontSize: normalize.font(15), color: Colors.text.primary, fontFamily: "Alexandria-Medium" },
  ...
  dayPriceInput: { width: '100%', height: 36, backgroundColor: '#F8FAFC', borderRadius: 8, borderWidth: 1, borderColor: '#E2E8F0', textAlign: 'center', fontSize: normalize.font(11), color: Colors.text.primary, fontFamily: "Alexandria-Medium", paddingHorizontal: 2 },
  shiftRow: { flexDirection: 'row', gap: Spacing.sm, paddingHorizontal: 14, marginBottom: 10 },
  categorySectionTitle: { fontSize: normalize.font(16), fontFamily: "Alexandria-Medium", color: Colors.text.primary, textAlign: 'center', marginBottom: 8 },
  featuresList: { gap: 8 },
  ...
  uploadText: { marginTop: 4, color: Colors.text.muted, fontSize: normalize.font(12), fontFamily: "Alexandria-Medium" },
  ...
  timeSelectText: { fontSize: normalize.font(15), fontFamily: "Alexandria-Medium", color: Colors.text.primary },
  ...
  bulkBtnText: { color: Colors.primary, fontSize: normalize.font(12), fontFamily: "Alexandria-Medium" },
