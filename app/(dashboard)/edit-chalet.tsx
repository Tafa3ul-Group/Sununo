...
const styles = StyleSheet.create({
  ...
  sectionHeader: { fontSize: normalize.font(16), fontFamily: "LamaSans-Black", color: Colors.text.primary, marginBottom: 2 },
  rowInputs: { gap: Spacing.sm },
  inputGroup: { gap: 6 },
  label: { ...Typography.caption, color: Colors.text.primary, fontFamily: "LamaSans-Black", fontSize: normalize.font(14) },
  smallLabel: { ...Typography.caption, color: Colors.text.muted, fontFamily: "LamaSans-SemiBold", fontSize: normalize.font(12) },
  input: {
    ...
    fontSize: normalize.font(15), color: Colors.text.primary, fontFamily: "LamaSans-Regular",
  },
  ...
  editLocText: { color: Colors.white, fontSize: normalize.font(12), fontFamily: "LamaSans-Bold" },
  // Shifts
  ...
  addShiftText: { color: Colors.primary, fontSize: normalize.font(14), fontFamily: "LamaSans-Bold" },
  shiftHint: { fontSize: normalize.font(13), color: Colors.text.muted, fontFamily: "LamaSans-Regular", marginBottom: 4 },
  ...
  shiftValueName: { fontSize: normalize.font(15), fontFamily: "LamaSans-Bold", color: Colors.text.primary },
  shiftPriceText: { color: Colors.text.primary, fontFamily: "LamaSans-Black" },
  addShiftBtnFull: {
    flexDirection: 'row', alignItems: 'center', gap: 8, justifyContent: 'center',
    paddingVertical: 12, borderStyle: 'dashed', borderWidth: 1.5, borderColor: Colors.primary + '40',
    borderRadius: 14, marginTop: 8,
  },
  addShiftBtnFullText: { color: Colors.primary, fontFamily: "LamaSans-Bold" },
  ...
  capacityLabel: { fontSize: normalize.font(18), fontFamily: "LamaSans-Bold", color: Colors.text.primary },
  capacitySubLabel: { fontSize: normalize.font(14), fontFamily: "LamaSans-Regular", color: Colors.text.muted },
  // Modal Edit
  shiftModalCard: { backgroundColor: '#F8FAFC', borderRadius: 16, padding: 16, gap: 16 },
  pricingSectionModal: { gap: 12 },
  pricingTitle: { fontSize: normalize.font(14), fontFamily: "LamaSans-Bold", color: Colors.text.primary },
  modalDeleteBtn: { paddingVertical: 16, alignItems: 'center' },
  modalDeleteText: { color: Colors.error, fontFamily: "LamaSans-Bold" },
  dayPricingGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 8 },
  dayPriceItem: { alignItems: 'center', gap: 4, width: '13%' },
  dayLabel: { fontSize: normalize.font(10), fontFamily: "LamaSans-Bold", color: Colors.text.muted },
  dayPriceInput: { width: '100%', height: 36, backgroundColor: '#F8FAFC', borderRadius: 8, borderWidth: 1, borderColor: '#E2E8F0', textAlign: 'center', fontSize: normalize.font(11), color: Colors.text.primary, fontFamily: "LamaSans-Medium", paddingHorizontal: 2 },
  ...
  categorySectionTitle: {
    fontSize: normalize.font(16), fontFamily: "LamaSans-Black", color: Colors.text.primary,
  ...
  featureName: {
    fontSize: normalize.font(14), fontFamily: "LamaSans-Bold", color: Colors.text.primary,
    flex: 1,
  },
  checkbox: {
  ...
  checkboxCheck: { color: '#FFFFFF', fontSize: normalize.font(14), fontFamily: "LamaSans-Bold" },
  uploadText: { marginTop: 4, color: Colors.text.muted, fontSize: normalize.font(12), fontFamily: "LamaSans-SemiBold" },
  ...
  coverBadgeText: { color: '#FFFFFF', fontSize: normalize.font(9), fontFamily: "LamaSans-Bold" },
  // Bottom sheets
  ...
  modalOptionText: { ...Typography.body, fontFamily: "LamaSans-SemiBold" },
