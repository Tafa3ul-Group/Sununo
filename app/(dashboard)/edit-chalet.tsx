...
const styles = StyleSheet.create({
  ...
  sectionHeader: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: Colors.text.primary, marginBottom: 2 },
  ...
  input: { height: normalize.height(48), backgroundColor: '#FFFFFF', borderRadius: normalize.radius(12), paddingHorizontal: Spacing.md, borderWidth: 1, borderColor: '#E8E8E8', fontSize: normalize.font(14), color: Colors.text.primary, fontFamily: "Alexandria-Medium" },
  ...
  editLocText: { color: Colors.white, fontSize: normalize.font(8), fontFamily: "Alexandria-Medium" },
  ...
  shiftIconLarge: { fontSize: 14 },
  shiftValueName: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: Colors.text.primary },
  ...
  capacityLabel: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: Colors.text.primary },
  ...
  dayLabel: { fontSize: normalize.font(8), fontFamily: "Alexandria-Medium", color: Colors.text.muted },
  dayPriceInput: { width: '100%', height: 36, backgroundColor: '#F8FAFC', borderRadius: 8, borderWidth: 1, borderColor: '#E2E8F0', textAlign: 'center', fontSize: normalize.font(8), color: Colors.text.primary, fontFamily: "Alexandria-Medium", paddingHorizontal: 2 },
  shiftRow: { flexDirection: 'row', gap: Spacing.sm, paddingHorizontal: 14, marginBottom: 10 },
  categorySectionTitle: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: Colors.text.primary, textAlign: 'center', marginBottom: 8 },
  featuresList: { gap: 8 },
  ...
  featureIconText: { fontSize: normalize.font(14), color: '#FFFFFF' },
  featureName: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: Colors.text.primary, flex: 1 },
  ...
  uploadText: { marginTop: 4, color: Colors.text.muted, fontSize: normalize.font(8), fontFamily: "Alexandria-Medium" },
  ...
  coverBadgeText: { color: '#FFFFFF', fontSize: normalize.font(8), fontFamily: "Alexandria-Medium" },
  ...
  pickerItemText: { ...Typography.body, fontSize: normalize.font(14), color: Colors.text.primary },
  ...
  timeSelectText: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: Colors.text.primary },
  ...
  bulkBtnText: { color: Colors.primary, fontSize: normalize.font(8), fontFamily: "Alexandria-Medium" },
