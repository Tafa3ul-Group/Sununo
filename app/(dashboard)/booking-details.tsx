...
const styles = StyleSheet.create({
  ...
  backBtnText: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Bold" },
  menuCircle: {
  ...
  simpleChaletName: { fontSize: normalize.font(16), fontFamily: "LamaSans-Black", color: '#1E293B', lineHeight: normalize.font(22) },
  simpleChaletLocation: { fontSize: normalize.font(14), fontFamily: "LamaSans-Medium", color: '#64748B', lineHeight: normalize.font(20), marginTop: 4 },
  infoSectionCard: { 
  ...
  sectionTitle: { fontSize: normalize.font(14), fontFamily: "LamaSans-Black", color: IDENTITY_BLUE, lineHeight: normalize.font(20) },
  divider: { height: 1, backgroundColor: '#F1F5F9', marginVertical: 10 },
  infoRow: { justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  infoLabel: { fontSize: normalize.font(14), fontFamily: "LamaSans-Bold", color: '#1E293B', lineHeight: normalize.font(20) },
  infoValue: { fontSize: normalize.font(14), fontFamily: "LamaSans-Medium", color: '#64748B', lineHeight: normalize.font(22) },
  blueValue: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Bold", lineHeight: normalize.font(22) },
  bottomActions: {
    position: 'absolute',
    bottom: 0,
    left: 0,
