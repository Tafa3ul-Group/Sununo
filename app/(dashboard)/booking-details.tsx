...
const styles = StyleSheet.create({
  ...
  simpleChaletName: { fontSize: normalize.font(16), fontFamily: "Alexandria-Medium", color: '#1E293B', textAlign: 'left', lineHeight: normalize.font(22) },
  ...
  sectionTitle: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: IDENTITY_BLUE, textAlign: 'left', lineHeight: normalize.font(20) },
  divider: { height: 1, backgroundColor: '#F1F5F9', marginVertical: 10 },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  infoLabel: { fontSize: normalize.font(14), fontFamily: "Alexandria-Medium", color: '#1E293B', textAlign: 'left', lineHeight: normalize.font(20) },
  ...
  blueValue: { color: IDENTITY_BLUE, fontFamily: "Alexandria-Medium", textAlign: 'right', lineHeight: normalize.font(22) },
  bottomActions: {
    position: 'absolute',
    bottom: 0,
    left: 0,
