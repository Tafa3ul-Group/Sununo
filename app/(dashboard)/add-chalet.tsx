...
const styles = StyleSheet.create({
  ...
  dayLabel: { fontSize: normalize.font(10), fontFamily: "LamaSans-Black", color: Colors.text.muted },
  dayPriceInput: {
    width: '100%', height: 36, backgroundColor: '#F8FAFC', borderRadius: 8,
    borderWidth: 1, borderColor: '#E2E8F0', textAlign: 'center',
    fontSize: normalize.font(11), color: Colors.text.primary, fontFamily: "LamaSans-Medium", paddingHorizontal: 2,
  },
  ...
  uploadText: { marginTop: normalize.height(4), color: Colors.text.muted, fontSize: normalize.font(12), fontFamily: "LamaSans-SemiBold" },
  photoHint: { fontSize: normalize.font(12), color: Colors.text.muted, fontFamily: "LamaSans-Regular", marginBottom: 4 },
