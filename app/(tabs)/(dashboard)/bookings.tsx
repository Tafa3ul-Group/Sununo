...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: normalize.font(14), color: '#64748B', fontFamily: "LamaSans-SemiBold", paddingVertical: normalize.height(2), lineHeight: normalize.font(20) },
  activeTabText: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Bold", paddingVertical: normalize.height(2), lineHeight: normalize.font(20) },
  ...
  filterToggleText: { fontSize: normalize.font(14), fontFamily: "LamaSans-SemiBold", color: '#64748B' },
  ...
  todayButtonText: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Bold", fontSize: normalize.font(12), lineHeight: normalize.font(16) },
  ...
  monthLabel: { fontSize: normalize.font(16), fontFamily: "LamaSans-Bold", color: IDENTITY_BLUE },
  ...
  selectedDayLabel: { color: '#FFF', fontFamily: "LamaSans-Regular", lineHeight: normalize.font(16) },
  ...
  selectedDateText: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Regular", lineHeight: normalize.font(18) },
  ...
  chaletChipText: { fontSize: normalize.font(12), fontFamily: "LamaSans-SemiBold", lineHeight: normalize.font(16), paddingTop: normalize.height(2) },
  ...
  shiftTileName: { fontSize: normalize.font(16), fontFamily: "LamaSans-Black" },
  shiftTimeGroup: { alignItems: 'center', gap: 4 },
  shiftTileTime: { fontSize: normalize.font(12), color: '#94A3B8', fontFamily: "LamaSans-SemiBold" },
  ...
  statusBadgeText: { fontSize: normalize.font(12), fontFamily: "LamaSans-Bold", lineHeight: normalize.font(18), paddingVertical: normalize.height(2) },

  bookingMiniInfo: { marginTop: 6, alignItems: 'center', gap: 6 },
  bookingMiniId: { fontSize: normalize.font(11), fontFamily: "LamaSans-Bold", letterSpacing: 0.5 },
  bookingTypeBadge: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4 },
  bookingTypeBadgeText: { fontSize: normalize.font(9), fontFamily: "LamaSans-Black", textTransform: 'uppercase' },

  noAvailabilityText: { textAlign: 'center', color: '#64748B', fontFamily: "LamaSans-SemiBold" },
  ...
  statusText: { fontSize: normalize.font(11), fontFamily: "LamaSans-Bold", lineHeight: normalize.font(16) },
  codeText: { fontSize: normalize.font(12), color: '#64748B', fontFamily: "LamaSans-Medium" },
  ...
  sheetContent: { flex: 1 },
  sheetTitle: { fontSize: normalize.font(18), fontFamily: "LamaSans-Black", marginBottom: 16 },
  textInput: { backgroundColor: '#F1F5F9', borderRadius: 12, padding: 12, minHeight: 80, marginBottom: 16, textAlignVertical: 'top' },
  inputLabel: { fontSize: normalize.font(14), fontFamily: "LamaSans-Bold", color: '#64748B', marginBottom: 8 },
  timeBlock: { gap: 2 },
  ...
  pickerColLabel: { fontSize: normalize.font(12), color: '#94A3B8', fontFamily: "LamaSans-Black", textTransform: 'uppercase', marginBottom: 12, letterSpacing: 0.5 },
  ...
  pickerItemTextNew: { fontSize: normalize.font(15), color: '#64748B', fontFamily: "LamaSans-SemiBold" },
  pickerItemTextActiveNew: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Black" },
