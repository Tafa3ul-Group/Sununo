...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: normalize.font(14), color: '#64748B', fontFamily: "LamaSans-SemiBold" },
  activeTabText: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Bold" },
  ...
  todayButtonText: { color: IDENTITY_BLUE, fontFamily: "LamaSans-Bold", fontSize: normalize.font(12) },
  ...
  chaletChipText: { fontSize: normalize.font(12), fontFamily: "LamaSans-SemiBold" },
  ...
  statusBadgeText: { fontSize: normalize.font(12), fontFamily: "LamaSans-Bold" },
  ...
  statusText: { fontSize: normalize.font(11), fontFamily: "LamaSans-Bold" },
