...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: normalize.font(14), color: '#64748B', fontWeight: '600', fontFamily: "LamaSans-SemiBold" },
  activeTabText: { color: IDENTITY_BLUE, fontWeight: '700', fontFamily: "LamaSans-Bold" },
  ...
  filterToggleText: { fontSize: normalize.font(14), fontWeight: '600', fontFamily: "LamaSans-SemiBold", color: '#64748B' },
  todayButton: { backgroundColor: '#EEF2FF', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8 },
  todayButtonText: { color: IDENTITY_BLUE, fontWeight: '700', fontFamily: "LamaSans-Bold", fontSize: normalize.font(12) },
  ...
  monthLabel: { fontSize: normalize.font(16), fontWeight: '700', fontFamily: "LamaSans-Bold", color: IDENTITY_BLUE },
  daysScroll: { gap: 10 },
  ...
  dateText: { fontSize: normalize.font(14), fontWeight: '700', fontFamily: "LamaSans-Bold" },
  ...
  chaletChipText: { fontSize: normalize.font(12), fontWeight: '600', fontFamily: "LamaSans-SemiBold" },
  ...
  shiftTileName: { fontSize: normalize.font(16), fontWeight: '800', fontFamily: "LamaSans-Black" },
  shiftTimeGroup: { alignItems: 'center', gap: 4 },
  shiftTileTime: { fontSize: normalize.font(12), color: '#94A3B8', fontWeight: '600', fontFamily: "LamaSans-SemiBold" },
  ...
  statusBadgeText: { fontSize: normalize.font(12), fontWeight: '700', fontFamily: "LamaSans-Bold" },

  bookingMiniInfo: { marginTop: 6, alignItems: 'center', gap: 6 },
  bookingMiniId: { fontSize: normalize.font(11), fontWeight: '700', fontFamily: "LamaSans-Bold", letterSpacing: 0.5 },
  bookingTypeBadge: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4 },
  bookingTypeBadgeText: { fontSize: normalize.font(9), fontWeight: '800', fontFamily: "LamaSans-Black", textTransform: 'uppercase' },

  noAvailabilityText: { textAlign: 'center', color: '#64748B', fontWeight: '600', fontFamily: "LamaSans-SemiBold" },
  ...
  customerName: { fontSize: normalize.font(15), fontWeight: '700', fontFamily: "LamaSans-Bold" },
  chaletName: { fontSize: normalize.font(12), color: '#64748B' , fontFamily: "LamaSans-Regular" },
  priceText: { fontSize: normalize.font(15), fontWeight: '800', fontFamily: "LamaSans-Black", color: IDENTITY_BLUE },
  dateHighlight: { backgroundColor: '#F8FAFC', padding: 10, borderRadius: 10, gap: 8, alignItems: 'center' },
  dateHighlightText: { fontSize: normalize.font(13), fontWeight: '600', fontFamily: "LamaSans-SemiBold", color: '#1E293B' },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  statusText: { fontSize: normalize.font(11), fontWeight: '700', fontFamily: "LamaSans-Bold" },
  codeText: { fontSize: normalize.font(12), color: '#64748B', fontWeight: '500', fontFamily: "LamaSans-Medium" },
  sheetLoading: { padding: 50, alignItems: 'center' },
  sheetScroll: { padding: 20 },
  sheetTopRow: { marginBottom: 20 },
  sheetHeroTitle: { fontSize: normalize.font(18), fontWeight: '800', fontFamily: "LamaSans-Black" },
  ...
  customerNameSheet: { fontSize: normalize.font(15), fontWeight: '700', fontFamily: "LamaSans-Bold" },
  ...
  detailCardTitle: { fontSize: normalize.font(15), fontWeight: '700', fontFamily: "LamaSans-Bold", flex: 1 },
  ...
  scheduleDate: { fontSize: normalize.font(13), fontWeight: '700', fontFamily: "LamaSans-Bold", flex: 1 },
  shiftChip: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  shiftChipText: { fontSize: normalize.font(10), fontWeight: '700', fontFamily: "LamaSans-Bold" },
  timeLabel: { fontSize: normalize.font(10), color: '#94A3B8', fontWeight: '700', fontFamily: "LamaSans-Bold", textTransform: 'uppercase' },
  timeValue: { fontSize: normalize.font(14), fontWeight: '800', fontFamily: "LamaSans-Black" },
  timeArrow: { paddingHorizontal: 8 },
  paymentTotalValue: { fontSize: normalize.font(16), fontWeight: '800', fontFamily: "LamaSans-Black", color: IDENTITY_BLUE },
  ...
  paymentTotalLabel: { fontSize: normalize.font(13), fontWeight: '600', fontFamily: "LamaSans-SemiBold" },
  sheetContent: { flex: 1 },
  sheetTitle: { fontSize: normalize.font(18), fontWeight: '800', fontFamily: "LamaSans-Black", marginBottom: 16 },
  textInput: { backgroundColor: '#F1F5F9', borderRadius: 12, padding: 12, minHeight: 80, marginBottom: 16, textAlignVertical: 'top' },
  inputLabel: { fontSize: normalize.font(14), fontWeight: '700', fontFamily: "LamaSans-Bold", color: '#64748B', marginBottom: 8 },
  timeBlock: { gap: 2 },
  ...
  pickerColLabel: { fontSize: normalize.font(12), color: '#94A3B8', fontWeight: '800', fontFamily: "LamaSans-Black", textTransform: 'uppercase', marginBottom: 12, letterSpacing: 0.5 },
  ...
  pickerItemTextNew: { fontSize: normalize.font(15), color: '#64748B', fontWeight: '600', fontFamily: "LamaSans-SemiBold" },
  pickerItemTextActiveNew: { color: IDENTITY_BLUE, fontWeight: '800', fontFamily: "LamaSans-Black" },
