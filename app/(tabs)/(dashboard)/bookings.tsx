...
const styles = StyleSheet.create({
  ...
  tabContainer: { paddingHorizontal: normalize.width(16), marginBottom: normalize.height(12) },
  tabs: { backgroundColor: '#F1F5F9', borderRadius: normalize.radius(12), padding: normalize.width(4) },
  tab: { flex: 1, paddingVertical: normalize.height(10), alignItems: 'center', borderRadius: normalize.radius(10) },
  activeTab: { backgroundColor: '#FFF', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  tabText: { fontSize: normalize.font(14), color: '#64748B', fontFamily: "Tajawal-SemiBold", paddingVertical: normalize.height(2), lineHeight: normalize.font(20) },
  activeTabText: { color: IDENTITY_BLUE, fontFamily: "Tajawal-Bold", paddingVertical: normalize.height(2), lineHeight: normalize.font(20) },
  filterRow: { paddingHorizontal: normalize.width(16), marginBottom: normalize.height(16), justifyContent: 'space-between', alignItems: 'center' },
  filterToggle: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  filterToggleText: { fontSize: normalize.font(14), fontFamily: "Tajawal-SemiBold", color: '#64748B' },
  todayButton: { backgroundColor: '#EEF2FF', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, minHeight: 32, justifyContent: 'center' },
  todayButtonText: { color: IDENTITY_BLUE, fontFamily: "Tajawal-Bold", fontSize: normalize.font(12), lineHeight: normalize.font(16) },
  calendarContainer: { paddingHorizontal: normalize.width(16), marginBottom: normalize.height(16) },
  calendarHeader: { justifyContent: 'space-between', alignItems: 'center', marginBottom: normalize.height(12) },
  monthLabel: { fontSize: normalize.font(16), fontFamily: "Tajawal-Bold", color: IDENTITY_BLUE },
  daysScroll: { gap: normalize.width(10) },
  dayItem: { alignItems: 'center', width: normalize.width(45), paddingVertical: normalize.height(10), borderRadius: normalize.radius(12) },
  selectedDayItem: { backgroundColor: IDENTITY_BLUE },
  dayLabel: { fontSize: normalize.font(12), color: '#64748B', marginBottom: 4, fontFamily: "Tajawal-Regular" },
  selectedDayLabel: { color: '#FFF', fontFamily: "Tajawal-Regular", lineHeight: normalize.font(16) },
  ...
  selectedDateText: { color: IDENTITY_BLUE, fontFamily: "Tajawal-Regular", lineHeight: normalize.font(18) },
  ...
  chaletChipText: { fontSize: normalize.font(12), fontFamily: "Tajawal-SemiBold", lineHeight: normalize.font(16), paddingTop: normalize.height(2) },
  ...
  shiftTileTime: { fontSize: normalize.font(12), color: '#94A3B8', fontFamily: "Tajawal-SemiBold" },
  ...
  statusBadgeText: { fontSize: normalize.font(12), fontFamily: "Tajawal-Bold", lineHeight: normalize.font(18), paddingVertical: normalize.height(2) },

  bookingMiniInfo: { marginTop: 6, alignItems: 'center', gap: 6 },
  bookingMiniId: { fontSize: normalize.font(11), fontFamily: "Tajawal-Bold", letterSpacing: 0.5 },
  bookingTypeBadge: { paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4 },
  bookingTypeBadgeText: { fontSize: normalize.font(9), fontFamily: "Tajawal-Black", textTransform: 'uppercase' },

  noAvailabilityText: { textAlign: 'center', color: '#64748B', fontFamily: "Tajawal-SemiBold" },
  ...
  chaletName: { fontSize: normalize.font(12), color: '#64748B', fontFamily: "Tajawal-Regular" },
  priceText: { fontSize: normalize.font(15), fontFamily: "Tajawal-Black", color: IDENTITY_BLUE },
  dateHighlight: { backgroundColor: '#F8FAFC', padding: 10, borderRadius: 10, gap: 8, alignItems: 'center' },
  dateHighlightText: { fontSize: normalize.font(13), fontFamily: "Tajawal-SemiBold", color: '#1E293B' },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, justifyContent: 'center' },
  statusText: { fontSize: normalize.font(11), fontFamily: "Tajawal-Bold", lineHeight: normalize.font(16) },
  codeText: { fontSize: normalize.font(12), color: '#64748B', fontFamily: "Tajawal-Medium" },
  ...
  customerNameSheet: { fontSize: normalize.font(15), fontFamily: "Tajawal-Bold" },
  customerPhone: { fontSize: normalize.font(13), color: '#64748B', fontFamily: "Tajawal-Regular" },
  ...
  detailCardTitle: { fontSize: normalize.font(15), fontFamily: "Tajawal-Bold", flex: 1 },
  detailSubRow: { paddingLeft: 40, alignItems: 'center', gap: 6, marginBottom: 12 },
  detailSubText: { fontSize: normalize.font(12), color: '#64748B', fontFamily: "Tajawal-Regular" },
  ...
  scheduleDate: { fontSize: normalize.font(13), fontFamily: "Tajawal-Bold", flex: 1 },
  ...
  timeLabel: { fontSize: normalize.font(10), color: '#94A3B8', fontFamily: "Tajawal-Bold", textTransform: 'uppercase' },
  timeValue: { fontSize: normalize.font(14), fontFamily: "Tajawal-Black" },
  timeArrow: { paddingHorizontal: 8 },
  paymentTotalValue: { fontSize: normalize.font(16), fontFamily: "Tajawal-Black", color: IDENTITY_BLUE },
  ...
  paymentTotalLabel: { fontSize: normalize.font(13), fontFamily: "Tajawal-SemiBold" },
  sheetContent: { flex: 1 },
  sheetTitle: { fontSize: normalize.font(18), fontFamily: "Tajawal-Black", marginBottom: 16 },
  textInput: { backgroundColor: '#F1F5F9', borderRadius: 12, padding: 12, minHeight: 80, marginBottom: 16, textAlignVertical: 'top' },
  inputLabel: { fontSize: normalize.font(14), fontFamily: "Tajawal-Bold", color: '#64748B', marginBottom: 8 },
  timeBlock: { gap: 2 },
  ...
  pickerColLabel: { fontSize: normalize.font(12), color: '#94A3B8', fontFamily: "Tajawal-Black", textTransform: 'uppercase', marginBottom: 12, letterSpacing: 0.5 },
  ...
  pickerItemTextNew: { fontSize: normalize.font(15), color: '#64748B', fontFamily: "Tajawal-SemiBold" },
  pickerItemTextActiveNew: { color: IDENTITY_BLUE, fontFamily: "Tajawal-Black" },
